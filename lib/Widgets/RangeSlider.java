...
{   
    ...
    final public static int PREFERRED_BREADTH = 1;
    final public static int PREFERRED_LENGTH = 1000;
     ...
     */
    public RangeSlider(int minimum, int maximum, int lowValue, int highValue, int orientation) {
     ...
     */
    public RangeSlider(int minimum, int maximum, int lowValue, int highValue, int orientation, int direction) {
        this(new DefaultBoundedRangeModel(lowValue, highValue - lowValue, minimum, maximum), 
     ...
     * @param direction - Is the slider left-to-right/top-to-bottom or right-to-left/bottom-to-top
     */
    public RangeSlider(BoundedRangeModel model, int orientation, int direction) {
