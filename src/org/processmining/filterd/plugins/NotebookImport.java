...
@Plugin(name = "Import a notebook file", level= PluginLevel.PeerReviewed, parameterLabels = { "Filename" }, 
returnLabels = { "Imported notebook File" }, returnTypes = {NotebookModel.class })
...
public class NotebookImport extends AbstractImportPlugin{
	...
	@Override
	protected NotebookModel importFromStream(final PluginContext context, final InputStream input, final String filename,
