 ...
 * It contains basic methods to create the UI, given a list of parameters.
 * Since the UI is generated based on the list of parameters, this procedure is completely automatic i.e. 
 * the user does not have to program the configuration panel herself (although this is possible as well).  
 * 
...
public abstract class AbstractFilterConfigPanelController {
	 ...
	 * This allows for exotic layouts which can be implemented per concrete class implementation.
	 * 
	 ...
	 * 
	 * @param parameter  parameter that the UI element should be based on.
	 */
	 ...
	 * 
	 * @param <N>  type of the parameter (can be either Integer or Double)
	 * @param parameter  parameter that the UI element should be based on.
	 */
	...
	public <N extends Number> void addParameterRangeFromRange(ParameterRangeFromRange<N> parameter) {
		...
		// add controller's contents to the next container
		getNextContainer().getChildren().add(controller.getContents());
		// make the range slider act like a time range slider
	 ...
	 * 
	 * @param <N1>  type of the value from range parameter (can be either Integer or Double)
	 * @param <N2>  type of the value from range parameter (can be either Integer or Double)
	 * @param parameters  list of parameters from which the UI components should be based on
	 */
