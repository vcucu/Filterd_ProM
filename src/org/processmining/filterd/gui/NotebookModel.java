...
public class NotebookModel {
	...
	public void saveNotebook() {
		...
		promContext.getProvidedObjectManager().createProvidedObject("Notebook File", newNotebook, NotebookModel.class,
				promContext);
	...
	public void printXML() {
		try {
            //Create JAXB Context
            JAXBContext jaxbContext = JAXBContext.newInstance(NotebookModelAdapted.class, TextCellModel.class, ComputationCellModel.class, FilterButtonModel.class);
...
//            jaxbMarshaller.marshal(model, file);
	...
	public class NotebookModelAdapter extends AbstractJAXBAdapter<NotebookModelAdapted, NotebookModel> {
		...
		public NotebookModel unmarshal(NotebookModelAdapted adaptedModel) throws Exception {
			...
			NotebookModel model = new NotebookModel(this.staticPromContext, this.staticInitialInput, this.staticPromCanceller);
